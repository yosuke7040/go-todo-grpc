...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/yosuke7040/go-todo-grpc/gen/eliza/v1"
	http "net/http"
	strings "strings"
)
...
func (UnimplementedElizaServiceHandler) Converse(context.Context, *connect.BidiStream[v1.ConverseRequest, v1.ConverseResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("eliza.v1.ElizaService.Converse is not implemented"))
}
...
func (UnimplementedElizaServiceHandler) Introduce(context.Context, *connect.Request[v1.IntroduceRequest], *connect.ServerStream[v1.IntroduceResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("eliza.v1.ElizaService.Introduce is not implemented"))
}
